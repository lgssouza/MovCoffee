<?php
    ...
    $rs        = $mysqli->query('SELECT COUNT(*) FROM `tb_pdcj_subgrupo_rel` a inner join `tb_pdcj_grupo_rel` b on a.fk_id_grupo = b.id_grupo order by subg_descricao asc');
	...
	$sql 	= "SELECT * FROM `tb_pdcj_subgrupo_rel` a inner join `tb_pdcj_grupo_rel` b on a.fk_id_grupo = b.id_grupo order by subg_descricao asc   
		...
		<div class="page-bar">
			...
			<div class="page-toolbar">
				<div class="btn-group pull-right">
					<button type="button" class="btn btn-fit-height green-jungle" onclick="cadastrosubgruposrel()">
			...
			<div class="col-md-12">
				...
				<div class="portlet box green-jungle">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-th"></i>Consulta de Sub-Grupos
						</div>
					...
					<div class="portlet-body">
						<div class="table-responsive">
							<table class="table table-striped table-hover" id="tbl_pdcj_subgrupos_rel">
								<thead>
									<tr>
								...
								<tbody>
									...
									<?php
										...
										{
									        echo	'<tr>
										          		<td style="display:none;">'.$regs[$i]->id_subgrupo.'</td>
														...
														//{
															echo '	<td align="center">
																		<a>
																			<span class="glyphicon glyphicon-pencil" id="'.$regs[$i]->id_subgrupo.'" style="color:green;width:100%;height:100%"></span>
																		</a>
																	</td>';
														//}
														//
														...
														//{
															echo '	<td align="center">
																		<a>
																			<span class="glyphicon glyphicon-trash" id="'.$regs[$i]->id_subgrupo.'" style="color:red;width:100%;height:100%"></span>
																		</a>
																	</td>';
														//}
						...
						<?php
							...
							echo paginacao_php(
												...
												'consultasubgruposrel', /** Nome da função javascrip arquivo 'funcoes.js' **/
												'sub-grupos'		 /** Descrição que aparecera na paginação **/
											  );
