<?php
	...
	{
		if(!empty($_GET["produto"]) && $_GET["produto"] != "undefined" && $_GET["produto"] != "nenhum")
		{
			$filtros = $filtros . " AND id = " . $_GET["produto"] . " ";
		}
	}	
	/** FIM FILTROS **/
    ...
    $rs 		= $mysqli->query('SELECT COUNT(*) FROM tb_produto'.$filtros);
...
<div class="page-content-wrapper">
	<div class="page-content">
			...
			<div class="page-toolbar">
				<div class="btn-toolbar">
					<div class="btn-group pull-right">
						<button style="width: 110px" type="button" class="btn btn-fit-height default green-jungle" id="btn_relatorio_produtos">
					...
					<div class="btn-group pull-right">	
						<button style="width: 110px" type="button" class="btn btn-fit-height default green-jungle" id="btn_filtros_produtos">
					...
					<div class="btn-group pull-right">
						<button style="width: 110px" type="button" class="btn btn-fit-height default green-jungle" onclick="cadastroprodutos()">
			...
			<div class="col-md-12">
				...
				<div class="portlet box green-jungle">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-user"></i>Consulta de Produtos
						</div>
					...
					<div class="portlet-body">
						<div class="table-responsive">
							<table class="table table-striped table-hover" id="tbl_produtos">
								<thead>
									<tr>
								...
								<tbody>									
									<?php
										...
										{
									        echo	'<tr>
										          		<td style="display: none">'.$produtos[$i]->id.'</td>
														...
														//{
															echo '	<td align="center">
																		<a>
																			<span class="glyphicon glyphicon-pencil" id="'.$produtos[$i]->id.'" style="color:green;width:100%;height:100%"></span>
																		</a>
																	</td>';
														//}
														...
														//{
															echo '	<td align="center">
																		<a>
																			<span class="glyphicon glyphicon-trash" id="'.$produtos[$i]->id.'" style="color:red;width:100%;height:100%"></span>
																		</a>
																	</td>';
														//}	
						...
						<?php
							...
							echo paginacao_php(
												...
												'consultaprodutos', 	 /** Nome da função javascrip arquivo 'funcoes.js' **/
												'produtos'				 /** Descrição que aparecera na paginação **/
											  );
		...
		<div id="modal_filtros_produtos" class="modal " tabindex="-1" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="submit" class="btn blue" id="btn_pesquisa_produtos">
							<i class="fa fa-search"></i>
							&nbsp;Pesquisar
						</button>
						
						<button type="button" class="btn red-thunderbird" id="btn_limpar_pesquisa_produtos">
