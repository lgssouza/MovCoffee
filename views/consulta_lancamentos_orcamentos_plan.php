<?php
    ...
    $rs        = $mysqli->query('select count(*) from tb_pdcj_grupo_plan a inner join tb_pdcj_grupo_plan_valores b on a.id_grupo = b.fk_id_grupo order by a.grup_descricao asc');
	...
	$sql 	= "select * from tb_pdcj_grupo_plan a inner join tb_pdcj_grupo_plan_valores b on a.id_grupo = b.fk_id_grupo order by a.grup_descricao asc   
			...
			<div class="page-toolbar">
				<div class="btn-toolbar">
					<div class="btn-group pull-right">
						<button type="button" class="btn btn-fit-height green-jungle" onclick="cadastrolancamentosorcamentosplan()">
				...
				<div class="portlet box green-jungle">
					...
					<div class="portlet-body">
						<div class="table-responsive">
							<table class="table table-striped table-hover" id="tbl_lancamentos_orcamentos_plan">
								<thead>
									<tr>
								...
								<tbody>
									...
									<?php
										...
										{
											echo	'<tr>
										          		<td style="display:none;">'.$regs[$i]->id_grupo_valores.'</td>
										          		<td>'.$regs[$i]->grup_descricao.'</td>
										          		<td>'.$regs[$i]->grup_objetivo.'</td>
										          		<td>'.$regs[$i]->grup_ano.'</td>';
										          		
														//if(verificapermissaoedicao("Categorias de Funcionário",$permissoes))
														//{
															echo '	<td align="center">
																		<a>
																			<span class="glyphicon glyphicon-pencil" id="'.$regs[$i]->id_grupo_valores.'" style="color:green;width:100%;height:100%"></span>
																		</a>
																	</td>';
														//}
														//
														...
														//{
															echo '	<td align="center">
																		<a>
																			<span class="glyphicon glyphicon-trash" id="'.$regs[$i]->id_grupo_valores.'" style="color:red;width:100%;height:100%"></span>
																		</a>
																	</td>';
														//}
						...
						<?php
							...
							echo paginacao_php(
												...
												'consultalancamentosorcamentosplan', /** Nome da função javascrip arquivo 'funcoes.js' **/
