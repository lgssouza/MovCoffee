<?php
	...
	/** INICIO FILTROS **/
	$filtros = "AND a.fk_produto = 1 AND a.tipo_movimentacao = 'S'";
    ...
    $rs        	= $mysqli->query('SELECT count(*)
							      ...
							      INNER JOIN mov_venda e ON e.fk_razao_produtos = a.id '. $filtros);
	...
	if($rs)
	{
		...
		while($venda_cafe = $rs->fetch_object())
		{
			array_push($vendas_cafe, $venda_cafe);
		}
...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="consulta_venda_cafe.php">Vendas de Café</a>
				</li>
			</ul>
			...
			<div class="page-toolbar">
				<div class="btn-toolbar">
					<div class="btn-group pull-right">
						<button style="width: 110px" type="button" class="btn btn-fit-height default green-jungle" id="btn_filtro_venda_cafe">
							<i class="fa fa-search"></i>
							&nbsp;Pesquisar
						</button>
					</div>										
					<div class="btn-group pull-right">
						<button style="width: 110px" type="button" class="btn btn-fit-height green-jungle" onclick="cadastrovendacafe()">
				...
				<div class="portlet box green-jungle">
					...
					<div class="portlet-body">
						<div class="table-responsive">
							<table class="table table-striped table-hover" id="tbl_vendas_cafe">
								<thead>
									<tr>
								...
								<tbody>									
									<?php
						      			...
						      			for($i=0;$i<count($vendas_cafe);$i++)
										{
											$valor = 0;
											
											if($vendas_cafe[$i]->valor_total != NULL)
											{
												$valor = 'R$ '.number_format($vendas_cafe[$i]->valor_total, 2, ',', '.');
											}
											else
											{
									        ...
									        echo	'<tr>
										          		<td style="display:none;">'.$vendas_cafe[$i]->id.'</td>
										          		<td>'.$vendas_cafe[$i]->data.'</td>
										          		<td>'.$vendas_cafe[$i]->prod_nome.'</td>
														<td>'.$vendas_cafe[$i]->prop_nome.'</td>
														<td>'.$vendas_cafe[$i]->lote_apas.'</td>
														<td>'.$vendas_cafe[$i]->lote_coperativa.'</td>
														<td>'.number_format($vendas_cafe[$i]->quantidade, 2, ',', '.').'</td>
										          		<td>'.$valor.'</td>';	
														...
														//{
															echo '	<td align="center">
																		<a>
																			<span class="glyphicon glyphicon-pencil" id="'.$vendas_cafe[$i]->id.'" style="color:green;width:100%;height:100%"></span>
																		</a>
																	</td>';
														//}
														...
														//{
															echo '	<td align="center">
																		<a>
																			<span class="glyphicon glyphicon-trash" id="'.$vendas_cafe[$i]->id.'" style="color:red;width:100%;height:100%"></span>
																		</a>
																	</td>';
														//}	
						...
						<?php
							...
							echo paginacao_php(
												...
												'consultavendascafe',		 /** Nome da função javascrip arquivo 'funcoes.js' **/
												'vendas de café'			 /** Descrição que aparecera na paginação **/
											  );
	...
	<!-- INICIO FIM MODAL DE CONSULTA -->
		<div id="modal_filtros_venda_cafe" class="modal " tabindex="-1" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="submit" class="btn blue" id="btn_pesquisa_venda_cafe">
							<i class="fa fa-search"></i>
							&nbsp;Pesquisar
						</button>

						<button type="button" class="btn red-thunderbird" id="btn_limpar_pesquisa_venda_cafe">
