<?php
	...
	if(isset($_GET["ano"]))
	{
		...
		{
			$filtros = $filtros . " AND c.subg_ano  =  ".$_GET["ano"]. "";			
		}
	}
	...
	$sql 	= "SELECT a.subg_descricao, b.grup_descricao, c.id_subgrupo_valores, 
...
<div class="page-content-wrapper">
	<div class="page-content">
			...
			<div class="page-toolbar">
				<div class="btn-toolbar">			
					<div class="btn-group pull-right">	
						<button style="width: 110px" type="button" class="btn btn-fit-height default green-jungle" id="btn_filtro_gastos_consultas">
			...
			<div class="col-md-12">
				...
				<div class="portlet box green-jungle">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-dollar"></i>Consulta de Gastos
						</div>
					...
					<div class="portlet-body">
						<div class="table-responsive">
							<table class="table table-striped table-hover" id="tbl_lancamentos_gastos_rel">
								<thead>
									<tr>
										...
										{	
									        ...
									        echo	'<tr>
														...
														//{
															echo '	<td align="center">
																		<a>
																			<span class="fa fa-external-link" id_subgrupo_valores="'.$regs[$i]->id_subgrupo_valores.'" style="color:green;width:100%;height:100%"></span>
																		</a>
																	</td>';
														//}
						...
						<?php
							...
							echo paginacao_php(
												...
												'consultalancamentosgastosrel', /** Nome da função javascrip arquivo 'funcoes.js' **/
												'gastos'		 /** Descrição que aparecera na paginação **/
											  );
		...
		<div id="modal_filtros_gastos_consulta" class="modal " tabindex="-1" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<div id="titulomodalpp">
								...
								Filtros para Consulta de Gastos (PDCJ)
							</div>
						</h4>
					</div>
					...
					<div class="modal-footer">
						<button type="submit" class="btn blue" id="btn_pesquisa_gastos_consulta">
							<i class="fa fa-search"></i>
							&nbsp;Pesquisar
						</button>
						
						<button type="button" class="btn red-thunderbird" id="btn_limpar_pesquisa_gastos_consulta">
