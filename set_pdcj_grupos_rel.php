<?php 
    ...
    if(!strcmp($acao,'adicionar') || !strcmp($acao,'editar'))
    {
        ...
        {           
            if(!$rs = $mysqli->query("INSERT INTO tb_pdcj_grupo_rel (
                                                            	grup_descricao
                                                           	  ) 
                                                     	values(
                                                              	'$descricao'                                                               
        ...
        elseif(!strcmp($acao,'editar'))
        {
            ...
            if(!$rs = $mysqli->query("UPDATE tb_pdcj_grupo_rel 
    ...
    elseif(!strcmp($acao,'excluir'))
    {
        ...
        if(!$res = $mysqli->query("DELETE FROM tb_pdcj_grupo_rel WHERE id_grupo = " . $idgrupo))
        {
